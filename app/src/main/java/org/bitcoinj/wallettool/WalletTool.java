...
public class WalletTool implements Callable<Integer> {
    ...
    public static class Condition {
        ...
        public boolean matchBitcoins(Coin comparison) {
            try {
                ...
                throw new IllegalArgumentException("Could not parse condition value: " + value);
            }
        }
    }
        ...
        if (peersStr != null) {
            ...
            for (String peer : peerAddrs) {
                try {
                    ...
                    throw new IllegalArgumentException("Could not resolve peer: " + peer);
                }
            }
        } else {
    ...
    private void syncChain() {
        try {
            ...
            try {
                ...
                throw new IllegalStateException("Chain download interrupted");
            }
    ...
    private void saveWallet(File walletFile) {
        try {
            ...
            e.printStackTrace();
            throw new IllegalStateException("Wallet creation failed: " + e.getMessage(), e);
        }
    }
